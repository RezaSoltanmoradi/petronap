...
const FileUpload = () => {
    ...
    const [rejctionValue, setRejectionValue] = useState();
                            ...
                            const goToPrevPage = e => {
                                ...
                                const filePdfHandler = (
                                    <div>
                                        ...
                                        >
                                            {/* <button className="goToPrevPage" onClick={goToPrevPage}>Prev</button>
                                            <button className="goToNextPage" onClick={goToNextPage}>Next</button> */}
                                            <img
    ...
    const fileHandler = event => {
        ...
        if (document.getElementById("file").files.length > 0) {
            if (
                document.getElementById("file").files[0].type == "image/png" ||
                document.getElementById("file").files[0].type == "image/jpeg" ||
                ...
                <form encType="multipart/form-data" action="">
                    {!view ? (
                        ...
                        <div>
                            ...
                            <div>{filePdf}</div>
                            {!url ? (
                                <button onClick={btnView} className="btnView">
                                    تایید
                                </button>
                            ) : (
                                <div>
