...
const Detail = () => {
    ...
    const { sendRequest: sendNewOffer, error: hasSendNewOfferError } =
        useRequest();
    const prepaymenPercentage = 20;
    const realPrecentageValue = (prepaymenPercentage / 100) * price;
    ...
    const confirmOfferHandler = () => {
        if (price) {
            sendNewOffer({
                ...
                data: {
                    price: price,
                    prepayment_percentage: prepaymenPercentage,
